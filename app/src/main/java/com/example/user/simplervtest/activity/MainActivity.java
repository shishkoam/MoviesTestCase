...
public class MainActivity extends AppCompatActivity implements Consts {
    ...
    private void loadMoviesFromServer() {
        ApiClient.getTopRatedMovies(new Callback<MoviesResponse>() {
            @Override
    ...
    private void setMoviesToRV(List<Movie> movies) {
        RecyclerBindingAdapter adapter =
                new RecyclerBindingAdapter<>(R.layout.list_item_movie, BR.movie, movies, true);
        adapter.setOnItemClickListener((position, item, view) -> {
            ImageView imageView = (ImageView) view.findViewById(R.id.imageView);
            Intent intent = new Intent(MainActivity.this, DetailsActivity.class);
            intent.putExtra(CURR_MOVIE, (Movie) item);
